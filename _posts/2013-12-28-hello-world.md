...
layout: post
title: Hello, world!
subtitle: This is where the subtitle goes and it is going to be really long to give a real impression of what an actual post would look like.
---

Poop! Welcome to [Hyde](http://andhyde.com), the perfect companion to [Jekyll](http://jekyllrb.com), the popular static site generator. Hyde is an elegant, open source, mobile first theme for Jekyll. It includes lightweight styles and placeholder content to get you up and running with a simple blog in no time.
